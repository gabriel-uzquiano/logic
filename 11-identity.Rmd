...
```{marginfigure, echo=TRUE}
<img src="images/ex 9.4.png" style="display:block; margin: 0 auto;">\
...
```{marginfigure, echo=TRUE}
<img src="images/ex 9.6.png" style="display:block; margin: 0 auto;">\
...
- The formula $\forall x (x = a \to Px)$ is true in the model because $(x = a \to Px)$ is true no matter what we assign to $x$: if we assign $p_1$ to $x$, then both antecedent and consequent come out true, but if we assign $p_2$ to $x$, the antecedent is false making the conditional true. 
...
- The formula $\forall x (Px \to x = b)$ is false in the model because $(Px \to x = b)$ is not true when we assign $p_2$ to $x$: $p_2$ is enclosed by a circle, but it is not one and the same object as the denotation of $b$. We conclude that the argument is invalid.
:::


```{marginfigure, echo=TRUE}
<img src="images/ex 9.7.png" style="display:block; margin: 0 auto;">\
...
The model depicted by the  diagram verifies the premises but not the conclusion.
...
<img src="images/ex 9.11.png" style="display:block; margin: 0 auto;">
:::
...
<img src="images/ex 9.10.png" style="display:block; margin: 0 auto;">
:::
