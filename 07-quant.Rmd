...
:::{.example}
Consider the expression: $(\forall x Pxy \to \exists y \ Qab)$. This is an official formula of the language.`r qfc_margin_tree(qformulas[["ch7-eg2a"]], height = 450L)`Here is a justification:
...
:::{.example}
Consider the expression: $\forall x (Pxy \to Qab)$. This is an official formula of the language.`r qfc_margin_tree(qformulas[["ch7-eg3a"]], height = 450L)`Here is a justification:

:::{.argument}
1. $Pxy$ is a formula (rule 1).
2. $Qab$ is a formula (rule 1).
3. $(Pxy \to \exists y \ Qab)$ is a formula (rule 2, from 1 and 2).
5. $\forall x (Pxy \to \exists y \ Qab)$ is a formula (rule 3, from 3).
:::
...
::: {.example}
Consider the expression: $Px \to \forall x Rxx$. This is an official formula of the language.The first two occurrences of the variable $x$ occur free in the formula:

```{r, results='asis', echo=FALSE}
qfc_embed_vars(qformulas[["ch7-eg4a"]], height = 520L)
```
...
::: {.example}
Consider the expression: $(\forall x \exists y Rxy \vee Qyx)$. This is an official formula of the language.The formula is open because the last occurrences of the variables $y$ and $x$ are free in the formula.

```{r, results='asis', echo=FALSE}
qfc_embed_vars(qformulas[["ch7-eg5"]], height = 520L)
```
...
:::{.example}
Consider the expression: $\forall x \exists y (Rxy \vee Qyx)$. This is an official formula of the language.The formula is closed because no occurrences of the variables $y$ or $x$ are free in the formula.

```{r, results='asis', echo=FALSE}
qfc_embed_vars(qformulas[["ch7-eg6"]], height = 520L)
```
